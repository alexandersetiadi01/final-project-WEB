...
unset($__errorArgs, $__bag); ?> col-10"  name="email" autocomplete="email" placeholder="e-mail" autofocus required >
                    </div>
                    <div class="textbox row">
                            <div class="mt-4 col">
                                <i class="fas fa-lock"></i>
                            </div>
                            <input type="password" class="input mt-3 <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?> col-10" name="password" id="exampleInputPassword1" placeholder="Password" autocomplete="current-password" required>
                    </div>
                ...
                <div class="Register" id = "Register">
                    <form method="POST" action="<?php echo e(route('register')); ?>">
                        ...
                        <div class="row">
                            <div class="col-5">
                            <input type="text" class="FName" name="firstname" placeholder="First name" value="<?php echo e(old('firstname')); ?>" required>
                            </div>
                            <div class="col-5">
                                <input type="text" class="FName" name="lastname" placeholder="Last name" value="<?php echo e(old('lastname')); ?>">
                            </div>
                        </div>
                        <div>

                        <input type="email" class="EmailRegister <?php echo e($errors-> has('email') ? 'is-invalid' : ''); ?>" name="email" id="inputEmail3" placeholder="Email" value="<?php echo e(old('email')); ?>" required>
                        ...
                        <div class="row">
                            <div class="col-5">
                                <input type="password" class="Passwords <?php echo e($errors-> has('password') ? 'is-invalid' : ''); ?>" name="password" placeholder="Password" required>
                            ...
                            <div class="col-5">
                                <input type="password" class="Passwords <?php echo e($errors-> has('re-password') ? 'is-invalid' : ''); ?>" name="re-password" placeholder="Re-Enter Password" required>
...
<?php /**PATH D:\Course\Projects\Web\RelaxnChat\resources\views/login.blade.php ENDPATH**/ ?>