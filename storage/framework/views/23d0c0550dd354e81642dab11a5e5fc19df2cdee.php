...
<body>
    <nav class="navbar navbar-expand-lg navbar-light" style="background-color: white;">
        ...
        <div>
            <form class="form-inline mt-3" method="GET" action="<?php echo e(route('findroom', array('searchroom' => "searchroom" ))); ?>">
...
<?php /**PATH D:\Course\Projects\Web\RelaxnChat\resources\views/layout/navbar.blade.php ENDPATH**/ ?>